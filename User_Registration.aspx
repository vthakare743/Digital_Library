<%@ Page Title="" Language="C#" MasterPageFile="~/HomeMasterPage.master" AutoEventWireup="true" CodeFile="User_Registration.aspx.cs" Inherits="User_Registration" %>
            ...
            <div class="row">
               ...
               <asp:RequiredFieldValidator ID="RequiredFieldValidator2" runat="server" 
                     ...
                     <asp:RegularExpressionValidator ID="RegularExpressionValidator3" runat="server" 
                        ...
                        <asp:TextBox ID="txtuser" runat="server" tabindex="8" class="form-control" placeholder="Enter User Name" autocomplete="off" BorderColor="#333333"></asp:TextBox>
                <asp:RequiredFieldValidator ID="RequiredFieldValidator1" runat="server" 
                          ControlToValidate="txtuser" Display="Dynamic" 
                           ErrorMessage="RequiredFieldValidator" ForeColor="#CC0000"  SetFocusOnError="True">Enter User Name !!!</asp:RequiredFieldValidator><span class="error"></span>
